    ...
    >
      ...
      >
        ...
        <MenuSection label={""}>
          ...
          <SubMenu
            label={dictionary["navigation"].quiz}
            icon={<i className="tabler-brain" />}
          >
            <MenuItem
              href={`/${locale}/apps/quiz/statistics`}
              icon={<i className="tabler-chart-bar" />}
            >
              {dictionary["navigation"].statistics}
            </MenuItem>
            <MenuItem
              href={`/${locale}/apps/quiz/history`}
              icon={<i className="tabler-report-medical" />}
            >
              {dictionary["navigation"].historyQuiz}
            </MenuItem>
          </SubMenu>
          <MenuItem
