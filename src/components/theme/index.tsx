...
const CustomThemeProvider = (props: Props) => {
  // Props
  const { children, direction, systemMode, locale } = props
  ...
  const theme = useMemo(() => {
    ...
    const coreTheme = deepmerge(defaultCoreTheme(settings, currentMode, direction, locale), newTheme)

    return createTheme(coreTheme)

    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [settings.primaryColor, settings.skin, currentMode, locale])
