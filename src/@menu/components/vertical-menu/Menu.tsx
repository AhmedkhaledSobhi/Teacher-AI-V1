      ...
      <FloatingTree>
        <StyledVerticalMenu
          ...
          rootStyles={{
            ...
            height: "100%",
            ...(rootStyles as CSSObject),
          }}
          {...rest}
        >
          <ul className={styles.ul} style={{ flex: 1, overflow: "auto" }}>
            {children}
          </ul>
          <div
            style={{
              marginTop: "auto",
              borderTop: "1px solid rgba(212, 189, 255, 0.10)",
          ...
          >
            <Button
              ...
              startIcon={
                <i className="tabler-logout" style={{ fontSize: "22px" }} />
              }
              sx={{
