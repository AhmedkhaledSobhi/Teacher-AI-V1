...
const Logo = ({ height, width, ...props }: LogoProps) => {
  // Aspect ratio: 107:100 (width:height)
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.2" stop-color="#6948B8" />
          <stop offset="1" stop-color="#BDA4F2" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color="#DC64C9" />
          <stop offset="1" stop-color="#5531A8" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.19" stop-color="#6948B8" />
          <stop offset="1" stop-color="#BDA4F2" />
        </linearGradient>
      </defs>
    </svg>
