...
type RobotMascotProps = SVGAttributes<SVGElement> & {
  ...
  return (
    <div className="animate-float">
      ...
      >
        ...
        <g
          className={`transition-all duration-100 ${isBlinking ? "scale-y-0" : "scale-y-100"}`}
        ...
        <g
          className={`transition-all duration-100 ${isBlinking ? "scale-y-0" : "scale-y-100"}`}
          style={{ transformOrigin: "67px 35px" }}
        >
          <path
        ...
        <path
          ...
          fill="url(#paint2_linear_11_763)"
        />

        <defs>
          <linearGradient
            id="paint0_linear_11_763"
            x1="38.8163"
            y1="60.3952"
            x2="76.7689"
            y2="98.3478"
          ...
          >
            <stop offset="0.2" stopColor="#6948B8" />
            <stop offset="1" stopColor="#BDA4F2" />
          </linearGradient>
          <linearGradient
            id="paint1_linear_11_763"
            x1="53.4545"
            y1="67.1185"
            x2="53.4545"
            y2="38.4894"
          ...
          >
            ...
            <stop offset="1" stopColor="#5531A8" />
          </linearGradient>
          <linearGradient
            id="paint2_linear_11_763"
            x1="0"
            y1="12.6585"
            x2="106.91"
            y2="12.6585"
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0.19" stopColor="#6948B8" />
            <stop offset="1" stopColor="#BDA4F2" />
          </linearGradient>
        </defs>
      </svg>
